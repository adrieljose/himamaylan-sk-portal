...
export const metadata: Metadata = {
  ...
  description:
    "Where to obtain the Certificate of Candidacy forms for the 2026 Barangay and Sangguniang Kabataan Elections in Himamaylan City, and what to do before you file.",
};
    ...
    <li className="border-b border-line">
      <div className="py-6 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-3 items-start">
        <div className="md:col-span-5">
          ...
          {form.formNumber && (
            <p className="mt-1.5 text-xs text-ink-600">{form.formNumber}</p>
          )}
        </div>
          ...
          {available ? (
            ...
            >
              ...
              <span className="sr-only">
                , {form.position}, opens in a new tab
              </span>
            </a>
          ) : (
            /*
  ...
  return (
    <>
      <PageHeader
        ...
        title="Certificate of Candidacy forms"
        intro="To stand for SK Chairperson or Kagawad you must file a Certificate of Candidacy with the Office of the Election Officer. This page tells you where the official forms come from and what to settle before you file."
      ...
      <section className="py-12 sm:py-16 lg:py-20 border-b border-line">
        <Container>
          {!HAS_PUBLISHED_FORMS && (
            <Notice
              tone="warning"
              title="The 2026 forms are not published on this page yet"
              className="mb-10"
            >
              COMELEC issues the Certificate of Candidacy forms for each election
              cycle. Until the 2026 Barangay and SK forms are confirmed, this page will
              not link to a file, because a form from the wrong election is not valid for
              filing. Obtain the current form from{" "}
              <a
              ...
              or directly from the Office of the Election Officer.
            </Notice>
          )}
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <Notice tone="statutory" title="Where the official forms come from">
              ...
              This page points to them; it does not produce them.{" "}
              <a
                href={COMELEC_BSKE_2026_URL}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="mt-10">
            <ContactPrompt
              ...
              body="The election office issues the forms, confirms your registration record, and answers questions this website cannot settle."
            />
          </div>
        </Container>
      </section>
